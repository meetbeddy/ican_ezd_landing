...
export default {
  landingPage: {
    ...
    about: {
      ...
      details: [
        ...
        {
          detail:
            "Consequently, we wish to also encourage you to take advantage of the conference interlude to send in your advert jingles that will be aired repeatedly during the conference and will also be hosted on both the Eastern Zonal Districts Application on Google playstore (ICAN EZD) and website www.icanezdconference.org.ng. This will enable you directly reach over Thirty Thousand (30000) Chartered Accountants and other participants that are anticipated to view the zone’s conference website or download the conference Application.",
        },
      ],
    },
  ...
  hotels: [
    {
      name: "SAN DIEGO HOTEL LIMITED",
      phoneNumber: "09025059119",
      distanceFromVenue: "LESS THAN 3KM FROM THE VENUE",
      rooms: [
        { type: "Standard", rate: 15200, flatRate: 15000, availableRooms: 11 },
        { type: "Double Luxury", rate: 18200, flatRate: 15000, availableRooms: 10 },
        { type: "Royal Deluxe", rate: 22200, flatRate: 15000, availableRooms: 5 },
        { type: "Jeff Suites", rate: 28200, flatRate: 15000, availableRooms: 6 },
      ],
    },
    {
      name: "SAN DIEGO HOTEL LIMITED (NEW EXTENSION)",
      phoneNumber: "",
      distanceFromVenue: "LESS THAN 3KM FROM THE VENUE",
      rooms: [
        { type: "Standard", rate: 20000, flatRate: 19000, availableRooms: 9 },
        { type: "Double Luxury", rate: 23000, flatRate: 19000, availableRooms: 8 },
        { type: "Author's Suites", rate: 33000, flatRate: 19000, availableRooms: 1 },
        { type: "Jeff Suites", rate: 38000, flatRate: 25000, availableRooms: 1 },
      ],
    },
    {
      name: "ANSON SUITE LIMITED",
      phoneNumber: "08137855219",
      distanceFromVenue: "LESS THAN 3KM FROM THE VENUE",
      rooms: [
        { type: "Duches", rate: 12000, flatRate: null, availableRooms: 1 },
        { type: "Dukes", rate: 15000, flatRate: null, availableRooms: 1 },
        { type: "Queen", rate: 20000, flatRate: 18000, availableRooms: 12 },
        { type: "Kings", rate: 25000, flatRate: 23000, availableRooms: 5 },
        { type: "Emperor", rate: 35000, flatRate: 33000, availableRooms: 3 },
      ],
    },
    {
      name: "HOTEL GENEZA",
      phoneNumber: "07033328253",
      distanceFromVenue: "LESS THAN 3KM FROM THE VENUE",
      rooms: [
        { type: "Standard Single", rate: 14500, flatRate: null, availableRooms: "NOT CONCLUDED" },
        { type: "Executive Single", rate: 15500, flatRate: null, availableRooms: null },
        { type: "Executive Double", rate: 16500, flatRate: null, availableRooms: null },
        { type: "Royal", rate: 17500, flatRate: null, availableRooms: null },
        { type: "Ambassadorial", rate: 18500, flatRate: null, availableRooms: null },
        { type: "Presidential", rate: 20000, flatRate: null, availableRooms: null },
      ],
    },
    {
      name: "MONABLISS HOTEL AND SUITES",
      phoneNumber: "",
      distanceFromVenue: "LESS THAN 3KM FROM THE VENUE",
      rooms: [
        { type: "Deluxe", rate: 13000, flatRate: null, availableRooms: 5 },
        { type: "Super Deluxe", rate: 16000, flatRate: null, availableRooms: 15 },
        { type: "Executive Deluxe", rate: 20000, flatRate: null, availableRooms: 10 },
        { type: "Ambassadorial Suites", rate: 25000, flatRate: null, availableRooms: 2 },
        { type: "Senators' Suites", rate: 35000, flatRate: null, availableRooms: 2 },
      ],
    },
    {
      name: "CLEVERO HOTEL",
      phoneNumber: "07030631660/08039553161",
      distanceFromVenue: "LESS THAN 3KM FROM THE VENUE",
      rooms: [
        { type: "Classic", rate: 15000, flatRate: 15000, availableRooms: 30 },
        { type: "Deluxe", rate: 20000, flatRate: 15000, availableRooms: null },
        { type: "Executive Deluxe", rate: 25000, flatRate: 15000, availableRooms: null },
        { type: "Deluxe Suites", rate: 40000, flatRate: 30000, availableRooms: 3 },
        { type: "Ambassadorial Suites", rate: 80000, flatRate: 50000, availableRooms: 1 },
      ],
    },
    {
      ...
      distanceFromVenue: "LESS THAN 3KM FROM THE VENUE",
      rooms: [
        { type: "Exclusive", rate: 35000, flatRate: 35000, availableRooms: 22 },
        { type: "Deluxe", rate: 40000, flatRate: null, availableRooms: null },
        { type: "Diplomatic", rate: 45000, flatRate: null, availableRooms: null },
        { type: "Presidential Suites", rate: 100000, flatRate: null, availableRooms: 2 },
      ],
    },
    {
      name: "RYAN HOTEL AND SUITES",
      phoneNumber: "09167775555",
      distanceFromVenue: "LESS THAN 3KM FROM THE VENUE",
      rooms: [
        { type: "Standard", rate: 35000, flatRate: 25000, availableRooms: 12 },
        { type: "Superior", rate: 40000, flatRate: 30000, availableRooms: 15 },
        { type: "Deluxe", rate: 60000, flatRate: 40000, availableRooms: 6 },
        { type: "Executive", rate: 85000, flatRate: 70000, availableRooms: 5 },
        { type: "Ryan Suites", rate: 145000, flatRate: 110000, availableRooms: 1 },
      ],
    },
    {
      name: "K-SUITES",
      phoneNumber: "08168820808",
      distanceFromVenue: "LESS THAN 1KM FROM VENUE",
      rooms: [
        { type: "Ambassadorial", rate: 15000, flatRate: 14000, availableRooms: 1 },
        { type: "Kings Luxury", rate: 12000, flatRate: 11000, availableRooms: 4 },
        { type: "Queen Luxury", rate: 10000, flatRate: 9000, availableRooms: 3 },
        { type: "Business Luxury", rate: 10000, flatRate: 9000, availableRooms: 1 },
      ],
    },
    {
      name: "FRANKLIN EXCLUSIVE HOTEL AND TOWER",
      phoneNumber: "09032802611/09026861174",
      distanceFromVenue: "LESS THAN 1KM FROM VENUE",
      rooms: [
        { type: "Standard", rate: 15000, flatRate: 15000, availableRooms: 8 },
        { type: "Deluxe", rate: 18000, flatRate: null, availableRooms: 5 },
        { type: "Super Deluxe", rate: 20000, flatRate: null, availableRooms: 2 },
        { type: "Executive", rate: 25000, flatRate: 20000, availableRooms: 8 },
        { type: "Mini Super Executives", rate: 30000, flatRate: 20000, availableRooms: 2 },
      ],
    },
    {
      name: "GARDEN VIEW HOLIDAY COTTAGE",
      phoneNumber: "",
      distanceFromVenue: "LESS THAN 1KM FROM VENUE",
      rooms: [
        { type: "Standard", rate: 15000, flatRate: 12000, availableRooms: 7 },
        { type: "Executive", rate: 20000, flatRate: 17000, availableRooms: 4 },
        { type: "Apartment", rate: 35000, flatRate: 25000, availableRooms: 4 },
      ],
    },
  ],
